...
<div class="container">
    <form action="includes/insert-inic.php" method="POST">
        <!-- This Row for Location Choosing -->
        <div class="row">
       <div class="col-md-4">
   ...
   <h2 align="center" class="buildingSpesific">Building Spesification</h2>
            <div class="row ">
                <!-- This Row after all rows  for building Spesifications -->
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <input type="submit" value="submit" stlye="margin-left:15px;" name="submit" class="btn btn-outline-success btn-lg btn-lock">
            <div style="margin-bottom:20px !important;">
            <p class="mt-5 mb-3 text-muted" align="center" >&copy; Created By The Gepettox</p>
            </div>
    </form>
</div>
